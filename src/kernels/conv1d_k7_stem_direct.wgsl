...
fn main(
    ...
    loop {
        ...
        loop {
            ...
            if (source_time >= 0 && source_time < i32(LENGTH)) {
                ...
                value = input_buf[input_channel * LENGTH + u32(source_time)];
            }
    ...
    if (time_0 < LENGTH) {
        output_buf[output_base_0 + time_0] = accumulator_00 + bias_buf[output_channel_0];
        output_buf[output_base_1 + time_0] = accumulator_01 + bias_buf[output_channel_1];
    }
    if (time_1 < LENGTH) {
        output_buf[output_base_0 + time_1] = accumulator_10 + bias_buf[output_channel_0];
        output_buf[output_base_1 + time_1] = accumulator_11 + bias_buf[output_channel_1];
    }
    if (time_2 < LENGTH) {
        output_buf[output_base_0 + time_2] = accumulator_20 + bias_buf[output_channel_0];
        output_buf[output_base_1 + time_2] = accumulator_21 + bias_buf[output_channel_1];
    }
    if (time_3 < LENGTH) {
        output_buf[output_base_0 + time_3] = accumulator_30 + bias_buf[output_channel_0];
        output_buf[output_base_1 + time_3] = accumulator_31 + bias_buf[output_channel_1];
    }
}
