...
fn main(
    ...
    if time_0 < LENGTH {
        output_buf[output_base_0 + time_0] = snake_epilogue(accumulator_00, output_channel_0);
        output_buf[output_base_1 + time_0] = snake_epilogue(accumulator_01, output_channel_1);
    }
    if time_1 < LENGTH {
        output_buf[output_base_0 + time_1] = snake_epilogue(accumulator_10, output_channel_0);
        output_buf[output_base_1 + time_1] = snake_epilogue(accumulator_11, output_channel_1);
    }
    if time_2 < LENGTH {
        output_buf[output_base_0 + time_2] = snake_epilogue(accumulator_20, output_channel_0);
        output_buf[output_base_1 + time_2] = snake_epilogue(accumulator_21, output_channel_1);
    }
    if time_3 < LENGTH {
        output_buf[output_base_0 + time_3] = snake_epilogue(accumulator_30, output_channel_0);
        output_buf[output_base_1 + time_3] = snake_epilogue(accumulator_31, output_channel_1);
    }
}
