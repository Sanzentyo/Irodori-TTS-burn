// Vector-staged direct JointAttention tail for the released v4-Small geometry.
//
// SDPA produces contiguous [B,H,S,Dh]. Four adjacent head components and the
// corresponding learned gates are loaded together, then expanded into the
