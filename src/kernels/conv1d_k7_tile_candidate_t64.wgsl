// Isolated T=64/O=32 candidate for the DACVAE residual k=7 Conv1d.
//
// Physical layouts:
...
// accumulators). The reduction and fma order match the accepted T64/O16
// production shader exactly.
//
