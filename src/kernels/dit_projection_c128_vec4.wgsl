// Generic C128 projection with vectorized K-contiguous input staging.
// A[M,K] and B[K,N] are row-major f32. Storage/workgroup traffic moves four
// adjacent input scalars together; four ordered FMA groups preserve the
// scalar kernel's K reduction order.
