// Exact FP32 K16 MLP contract with register-prefetched global tiles.
//
// Each invocation fetches its next input vector and two weight vectors before
// the overwrite barrier. The shared-memory footprint stays at 12 KiB, while
// global latency can overlap useful work from other invocations in the group.
