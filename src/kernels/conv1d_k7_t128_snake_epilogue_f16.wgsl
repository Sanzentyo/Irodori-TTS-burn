...
// Production T128 k=7 Conv1d + ResidualUnit act1 Snake epilogue.
//
// The convolution body below mirrors conv1d_k7_t128.wgsl. Only the fifth
// alpha binding, scalar Snake helper, and the output-store epilogue differ.
//
// Physical layouts:
...
// Keep this scalar operation sequence identical to snake.wgsl. Each vector
// component reaches it only after the unchanged T128 convolution reduction.
