...
pub const ROUTE_ABI_VERSION: &str = "v4-dit-route-27";
...
pub enum MlpContractRoute {
    ...
    /// A 96x128 K16 tile that retains the 256-invocation workgroup and
    /// register-prefetch schedule while reducing repeated weight loads.
    HandwrittenRows96K16PrefetchedPitchedVectorInput,
    ...
    pub const fn is_handwritten(self) -> bool {
        matches!(
            ...
            Self::HandwrittenT64Contiguous
                ...
                | Self::HandwrittenRows96K16PrefetchedPitchedVectorInput
...
pub enum SwiGluRoute {
    ...
    /// Cooperative CubeK plane partitioning with register F32 tile math and
    /// the same compressed writer. It remains available when accelerator
    /// matrix types would change precision or are unsupported.
    CubeKCompressedInterleavedPlaneVec,
...
impl RouteOperation {
    pub fn candidates(self, problem: RouteProblem) -> &'static [RouteChoice] {
        ...
        const MLP_EXPAND_ALL: [RouteChoice; 13] = [
            ...
            RouteChoice::MlpExpand(SwiGluRoute::CubeKCompressedInterleavedPlaneVec),
        ...
        const MLP_CONTRACT_ALL: [RouteChoice; 22] = [
            RouteChoice::MlpContract(MlpContractRoute::DefaultGraph),
            ...
            RouteChoice::MlpContract(
                MlpContractRoute::HandwrittenRows96K16PrefetchedPitchedVectorInput,
            ),
            RouteChoice::MlpContract(
