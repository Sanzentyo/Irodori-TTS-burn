...
10. **Algorithmic optimizations (LibTorch MPS f16)**:
    - Euler-40 baseline: RTF=0.379 (reference)
    - Heun-20 (same NFE=40): RTF=0.367, PSNR=42.67 dB — best quality, slightly faster
    - **Euler-25**: RTF=0.241, PSNR=40.84 dB — **best speed-quality tradeoff** (preferred over PLMS4-25)
    - PLMS4-25 + cfg_min_t=0.65: RTF=0.204, PSNR=37.82 dB — **absolute fastest**
...
Note: Euler-25 and PLMS4-25 have identical RTF (0.241) but Euler-25 has higher quality
(PSNR=40.84 dB vs 38.28 dB). Euler-25 is recommended over PLMS4-25 for production use.
...
(seed=42, [1,750,32] f32 safetensors). Reference is Euler-40. Latents were generated by
...
| Sampler | Steps | NFE | RTF | MAE | RMSE | CosSim | PSNR |
|---|---|---|---|---|---|---|---|
| Euler-40 | 40 | 40 | 0.379 | reference | reference | 1.0 | ∞ |
| Heun-20 | 20 | 40 | 0.367 | 0.01676 | 0.03263 | 0.999697 | **42.67 dB** |
| Euler-25 | 25 | 25 | 0.241 | 0.02195 | 0.04030 | 0.999574 | **40.84 dB** |
| PLMS4-25 | 25 | 25 | 0.241 | 0.02589 | 0.05407 | 0.999305 | 38.28 dB |
| PLMS4-25 + cfg=0.65 | 25 | ~18.5 | 0.204 | 0.02714 | 0.05705 | 0.999246 | 37.82 dB |
| PLMS4-20 | 20 | 20 | ~0.193 | 0.02850 | 0.06136 | 0.998982 | 37.19 dB |

**Key findings**:
1. All samplers achieve CosSim > 0.999 — perceptible difference from Euler-40 is minimal for all.
2. **Heun-20 has the best quality-per-NFE** (42.67 dB at same NFE=40; slightly faster due to fewer loop iterations).
3. **Euler-25 is the best speed-quality tradeoff** at RTF=0.241 (PSNR=40.84 dB, 36% faster).
4. **PLMS4-25 has identical RTF to Euler-25 but lower quality** — Euler-25 is preferred over PLMS4-25.
5. **PLMS4 advantage emerges at ≤20 steps**: PLMS4-20 (RTF~0.193, PSNR=37.19 dB) vs Euler-20 (not benchmarked).
6. **cfg_min_t=0.65 with PLMS4-25**: minimal quality cost (37.82 vs 38.28 dB, −0.46 dB). Safe to use.
7. PSNR > 35 dB is generally considered excellent for audio; all variants exceed this threshold.

**Production recommendations**:
- **Best quality**: Heun-20 (RTF=0.367, equivalent NFE to baseline, PSNR=42.67 dB)
- **Best speed+quality**: Euler-25 (RTF=0.241, PSNR=40.84 dB) — preferred over PLMS4-25
- **Fastest acceptable**: PLMS4-25 + cfg_min_t=0.65 (RTF=0.204, PSNR=37.82 dB)
